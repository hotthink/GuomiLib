...
/* sm2_shared_secret() function.
Compute a shared secret given your secret key and someone else's public key.
Note: It is recommended that you hash the result of sm2_shared_secret before using it for symmetric encryption or HMAC.
...
/* sm2_sign() function.
Generate an sm2 signature for a given hash value.
